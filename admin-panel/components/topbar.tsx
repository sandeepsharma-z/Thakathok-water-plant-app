      ...
      <div className="relative flex flex-wrap items-center gap-3">
        ...
        <div className="order-2 flex items-center gap-2.5 lg:order-3">
          ...
          <motion.div
            ...
            className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-gradient-to-br from-[#004fda] to-[#37b6ff] text-[13px] font-bold text-white shadow-[0_8px_18px_-8px_rgba(0,79,218,0.9)]"
          >
